<h1>Py++(PyPP) - Python与C++的融合体 - A fusion of Python and C++</h1>

<h2>中文版 - Chinese</h2>
<h3>Py++ 是一种解释型、静态类型的 Python 方言。它构建了数学库、I/O 库、以及 Python 原生语法支持。</h3>
<h3>Py++ 旨在于让 C++ 转 Python 的学生/程序员更快适应 Python。</h3>
...
<h2>示例 - Example</h2>
<h3>在 test/ 文件夹中获得示例。</h3>
<h3>See examples in the test/ folder.</h3>
